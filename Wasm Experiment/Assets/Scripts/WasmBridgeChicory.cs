...
public class WasmBridgeChicory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // becomes
        {
            ...
            using AndroidJavaObject input = new AndroidJavaObject("java.lang.String", "Hello World");
            using AndroidJavaObject pluginFunc = new AndroidJavaObject("java.lang.String", "greet");
            using AndroidJavaObject resultBytes = PluginObj.Call<AndroidJavaObject>("call", pluginFunc, input.Call<AndroidJavaObject>("getBytes", UTF_8));
            using AndroidJavaObject resultString = new AndroidJavaObject("java.lang.String", resultBytes, UTF_8);
